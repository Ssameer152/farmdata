...
if(isset($_GET['start_date']) && isset($_GET['end_date']) && $_GET['start_date']!='' && $_GET['end_date']!='')
{
    ...
    $q = "SELECT id,cast(doe as date) as d, activity,people FROM logs WHERE cast(doe as date)>='$start_date' AND cast(doe as date)<='$end_date' and is_deleted=0 ORDER BY doe";
    $r = mysqli_query($db,$q);
...
while($res = mysqli_fetch_assoc($r)){
    ...
    $q2 = "SELECT activity FROM activities WHERE id='$activity' and is_deleted=0";
