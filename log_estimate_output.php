...
echo <<<_END
		...
		<div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2>Log Outputs Estimate</h2>
_END;


    echo <<<_END
                        <form action="log_estimate_output_ap.php" method="post">
...
$q = "SELECT sum(qty) as qty,resourceid FROM estimate_log_output WHERE logid='$logid' GROUP BY resourceid";
$r = mysqli_query($db,$q);
$sn = 0;
while($res = mysqli_fetch_assoc($r))
{
