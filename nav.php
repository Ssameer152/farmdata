		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="Navbar">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a class="nav-link" href="#"><span class="fa fa-list fa-lg"></span> Activities</a></li>
					<li class="nav-item"><a class="nav-link" href="#"><span class="fa fa-address-card fa-lg"></span> Logs</a></li>
				</ul>
