...
if(isset($_SESSION['user']))
{
    ...
    if(isset($_POST['area']) && $_POST['area']!='' && isset($_POST['qty']) && $_POST['qty']!='' && isset($_POST['logid']) && $_POST['logid']!='')
    {
        ...
        $q = "INSERT INTO estimate_log_resource(logid,resourceid,qty) VALUES('$logid','$area','$qty')";
        $r = mysqli_query($db,$q);
        
        $msg = "Work Log Added";
        echo <<<_END
        <meta http-equiv='refresh' content='0;url=log_estimate_resource.php?logid=$logid&msg=$msg'>
_END;
    }
    else
    {
